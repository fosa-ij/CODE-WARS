...
function smallWordHelper(sentence) {
  //first task will be to grab all words 3 char or less into a variable/array
  //no! loop throuh the array, using the map function. for each element/word, check for 3 or less char and capitalize
  // for 4 or more char, remove their vowels
